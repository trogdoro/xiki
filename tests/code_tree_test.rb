...
#   # Should ignore parent when child is root
#   def test_ignore_parent_with_params
#     code = CodeTree.determine_code_from_path([
#       "- Foo.menu('hey')",
#       "- Wiki.pages('new')"])
#     assert_equal("Wiki.pages('new')", code)
...
#   def test_definite_code_tree_root
#     assert CodeTree.definite_code_tree_root('Hey.you/')
#     assert CodeTree.definite_code_tree_root('Hey.you()')
#     assert ! CodeTree.definite_code_tree_root('Rakefile.rb')
#   end

#   def test_maybe_code_tree_root
#     assert CodeTree.maybe_code_tree_root('Hey.you')
#     assert ! CodeTree.maybe_code_tree_root('hey.you')
#   end

#   def test_definite_dir_tree_root
#     assert CodeTree.definite_dir_tree_root('/hey')
#     assert ! CodeTree.definite_dir_tree_root('hey/')
#   end
